...
그래서 특정 언어를 다양한 언어로 번역할 수 있도록 수많은 인코딩 테이블(특정 언어의 집합 테이블)이 만들어지고 이를 사용하게 되었습니다, 이러한 수많은 인코딩 테이블을 저장하고 특정 인코딩을 다른 인코딩으로 변환 할 수 있도록 하는 리눅스에ㅓ iconv라는 명령어가 만들어지게 되었습니다.
...
여기서 위와 같이 단일 인코딩만 진행하는것이 아니라, 파이프 기호("|")를 통해 인코딩 방식을 채이닝할 수 있습니댜.
